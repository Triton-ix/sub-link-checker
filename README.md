...
لینک زیر شامل **<u>25030 کانفیگ تست‌شده و فعال</u>** است که در بیش از **<u>158 لینک سابسکریپشن</u>** و در مجموع از بین **<u>619479 کانفیگ مختلف</u>** تکراری و خراب تست و استخراج شده‌اند.
