...
لینک زیر شامل **4664** کانفیگ تست‌شده و فعال است که در بیش از **790** لینک سابسکریپشن و در مجموع از بین **823709** کانفیگ مختلف (تکراری و خراب) تست و استخراج شده‌اند.
...
**آخرین بروزرسانی :** در تاریخ 1405/02/13 و در ساعت 23:15:02
...
|------|----------------|------------------|------------------|----------------|-------------------|---------------------|----------------|---------------------|
| **تعداد** | 790 | 790 | 0 | 823709 | 439684 | 384025 | 379361 | 4664 |
| **درصد** | 100% | 100.0% | 0.0% | 100% | 53.4% | 46.6% | 98.8% | 1.2% |
