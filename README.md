...
لینک زیر شامل **82609** کانفیگ تست‌شده و فعال است که از بیش از **790** لینک سابسکریپشن و در مجموع از بین **823309** کانفیگ مختلف (تکراری و خراب) تست و استخراج شده‌اند.
...
**📅 آخرین بروزرسانی :** در تاریخ **1405/02/14 04:09:44** به وقت ایران
...
|------|------------------|----------------|----------------|----------------|------------------|---------------------|---------------|------------------|
| **تعداد** | 790 | 790 | 0 | 823309 | 444351 | 378958 | 296349 | 82609 |
| **درصد** | 100% | 100.0% | 0.0% | 100% | 54.0% | 46.0% | 78.2% | 21.8% |
