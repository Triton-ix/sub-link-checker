...
لینک زیر شامل **65385** کانفیگ تست‌شده و فعال است که از بیش از **790** لینک سابسکریپشن و در مجموع از بین **823309** کانفیگ مختلف (تکراری و خراب) تست و استخراج شده‌اند.
...
**📅 آخرین بروزرسانی :** در تاریخ **1405/02/14 03:18:09** به وقت ایران
...
|------|------------------|----------------|----------------|----------------|------------------|---------------------|---------------|------------------|
| **تعداد** | 790 | 790 | 0 | 823309 | 444351 | 378958 | 313573 | 65385 |
| **درصد** | 100% | 100.0% | 0.0% | 100% | 54.0% | 46.0% | 82.7% | 17.3% |
