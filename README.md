...
لینک زیر شامل **40542** کانفیگ تست‌شده و فعال است که از بیش از **790** لینک سابسکریپشن و در مجموع از بین **829280** کانفیگ مختلف (تکراری و خراب) تست و استخراج شده‌اند.
...
**📅 آخرین بروزرسانی :** در تاریخ **1405/02/14 08:32:44** به وقت ایران
...
|------|------------------|----------------|----------------|----------------|------------------|---------------------|---------------|------------------|
| **تعداد** | 790 | 790 | 0 | 829280 | 444971 | 384309 | 343767 | 40542 |
| **درصد** | 100% | 100.0% | 0.0% | 100% | 53.7% | 46.3% | 89.5% | 10.5% |
